...
- **Zoom Phone credential UX backlog:** documented the near-term follow-up to move Zoom Phone S2S credential entry from operator-managed env values into encrypted per-tenant admin/operator setup with a connection test and clear status states.
