...
const termsSections = [
  ...
  ['connected-services', 'Connected services', [
    'Clarity Legal may connect with third-party services selected by your organization, including supported Microsoft, Google, Zoom, QuickBooks, Teams, email, file-storage, model-provider, and payment services. Your use of a connected service is also subject to that provider’s terms and permissions. Clarity Legal is not responsible for a third-party service’s availability, changes, or independent handling of information. Disconnect integrations you no longer authorize.',
  ]],
  ...
  ['ownership-and-feedback', 'Ownership and feedback', [
    'Clarity Legal and its licensors retain rights in the service, software, interface, and related materials. These Terms do not transfer ownership of workspace content to Clarity Legal. If you provide product feedback, you allow us to use it to evaluate and improve the service without an obligation to compensate you. Any broader license or data-use terms are governed by the applicable organization agreement.',
  ]],
  ...
  ['liability', 'Liability', [
    'Liability between Clarity Legal and an organization is governed by the applicable subscription agreement. To the extent these Terms apply independently and to the extent permitted by law, Clarity Legal is not liable for indirect, incidental, special, consequential, or punitive damages, or for losses caused by reliance on unreviewed output, unauthorized use, or third-party services. Nothing in these Terms limits liability that cannot lawfully be limited.',
  ]],
...
const notices = {
  privacy: {
    ...
    intro: 'This Privacy Policy explains how Clarity Legal handles personal information when you visit our public website, request access, or use a Clarity Legal workspace. Clarity Legal is a multi-tenant, AI-assisted legal operations platform for law firms and legal professionals.',
    sections: privacySections,
    otherPath: '/terms',
    otherLabel: 'Terms of Use',
  },
  terms: {
    eyebrow: 'Rules for using Clarity Legal',
    title: 'Terms of Use',
    intro: 'These Terms of Use apply to the Clarity Legal public website and to your access to a Clarity Legal workspace. Clarity Legal is a multi-tenant, AI-assisted legal operations platform for law firms and legal professionals.',
    ...
    <div id='top' className='min-h-screen bg-brand-bg text-brand-ink'>
      ...
      <header className='sticky top-0 z-40 border-b border-brand-line bg-brand-bg/90 backdrop-blur'>
        <div className='mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6'>
          <Link to='/' aria-label='Clarity Legal home' className='flex items-center gap-2.5 rounded-lg'>
            <span className='flex h-8 w-8 items-center justify-center rounded-lg border border-brand-line bg-brand-bg-soft shadow-sm'><Logo size={16} /></span>
            <span className='font-serif text-[17px] font-bold tracking-tight'>Clarity <span className='hidden sm:inline'>Legal</span></span>
          </Link>
      ...
      <footer className='border-t border-brand-line bg-brand-surface'>
        <div className='mx-auto flex max-w-6xl flex-col gap-5 px-5 py-8 sm:px-6 md:flex-row md:items-center md:justify-between'>
          <div className='flex items-center gap-2.5'><Logo size={18} /><span className='font-serif text-[15px] font-bold'>Clarity Legal</span></div>
