...
const TOOL_DOCS = [
  ...
  ['get_authority_treatment', 'Show linked source facts plus provisional or attorney-reviewed treatment; never a good-law determination'],
  ['get_citator_status', 'Show citator source/version evidence, currentness limits, and known gaps'],
