      ...
      <section className="border-y border-brand-line bg-brand-bg-soft/45">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-16 md:py-24 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-[12px] leading-relaxed text-brand-ink-2">Which administrator must consent, the exact scopes each provider requests, and the onboarding sequence are published on the <Link to="/requirements" className="font-semibold text-brand-accent-2 hover:underline">requirements page</Link>.</p>
          </div>
          <div>
