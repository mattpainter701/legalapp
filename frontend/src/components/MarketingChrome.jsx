    ...
    <header className="sticky top-0 z-40 border-b border-brand-line bg-brand-bg/90 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link to="/demo" className="inline-flex min-h-11 items-center gap-2 rounded-lg bg-brand-ink px-3.5 text-[13px] font-semibold text-white shadow-sm transition-all hover:-translate-y-px hover:bg-brand-ink-2 sm:px-4 sm:text-[14px]">
