...
export default function GeneratedSigningPlacementReview({ source, signerRoles = EMPTY, initialFields = EMPTY, onChange }) {
  ...
  useEffect(() => {
    let live = true
    setVerified(null); setFields(EMPTY); setFailure(''); onChange?.([])
