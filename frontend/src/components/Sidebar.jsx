...
import { Plus, Blocks, FileText, Trash2, Settings, Scale, CheckCircle2, Loader2, Search, Pin, X, BarChart2, CalendarDays, MessageSquare, FileSignature, Briefcase, Clock, Receipt, User, Vault, Handshake } from 'lucide-react'
  ...
  return (
    <div className="w-[300px] flex-shrink-0 border-r border-brand-line flex flex-col h-full bg-brand-surface-2 relative z-20">
      ...
      <div className="p-4 flex flex-col gap-2 border-b border-brand-line shrink-0">
        ...
        >
          <span className="flex items-center gap-2">
            <Handshake className="w-4 h-4" /> Mediation
          </span>
        </button>
        <button
