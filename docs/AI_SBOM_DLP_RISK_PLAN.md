...
- Generate the repository tracking inventory with `python scripts/generate_sbom_inventory.py`; the generated outputs are `docs/SBOM_TRACKING_INVENTORY.md` for reviewers and `sbom/sbom-inventory.json` for automation.
