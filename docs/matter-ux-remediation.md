...
Running the journey end to end against the real application, rather than fixtures, uncovered six defects that unit tests with mocked transports could not see. All are fixed in this PR.
