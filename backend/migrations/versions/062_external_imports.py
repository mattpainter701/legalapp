...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(50),
            nullable=False,
            server_default="tabs3_reference",
        ),
    ...
    op.create_index(
        "idx_external_system_connections_tenant",
        "external_system_connections",
        ["tenant_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "connection_id",
            UUID(as_uuid=True),
            sa.ForeignKey("external_system_connections.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("provider", sa.String(100), nullable=False),
    ...
    op.create_index(
        "idx_external_import_runs_tenant", "external_import_runs", ["tenant_id"]
    )
    op.create_index(
        "idx_external_import_runs_connection", "external_import_runs", ["connection_id"]
    )
    op.create_index(
        "idx_external_import_runs_status",
        "external_import_runs",
        ["tenant_id", "status"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "import_run_id",
            UUID(as_uuid=True),
            sa.ForeignKey("external_import_runs.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("provider", sa.String(100), nullable=False),
    ...
    op.create_index(
        "idx_external_raw_rows_table",
        "external_raw_rows",
        ["tenant_id", "provider", "source_table"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "import_run_id",
            UUID(as_uuid=True),
            sa.ForeignKey("external_import_runs.id", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_index(
        "idx_external_record_links_tenant", "external_record_links", ["tenant_id"]
    )
    op.create_index(
        "idx_external_record_links_source",
        "external_record_links",
        ["tenant_id", "provider", "source_table"],
    )
    op.create_index(
        ...
        "external_record_links",
        ["tenant_id", "target_table", "target_record_id"],
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_external_record_links_target", table_name="external_record_links"
    )
    op.drop_index(
        "idx_external_record_links_source", table_name="external_record_links"
    )
    op.drop_index(
        "idx_external_record_links_tenant", table_name="external_record_links"
    )
    ...
    op.drop_index(
        "idx_external_import_runs_connection", table_name="external_import_runs"
    )
    ...
    op.drop_index(
        "idx_external_system_connections_tenant",
        table_name="external_system_connections",
    )
