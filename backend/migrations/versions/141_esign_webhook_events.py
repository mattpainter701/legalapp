...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint("provider", "event_id", name="uq_esign_webhook_provider_event"),
    )
    op.create_index("idx_esign_webhook_envelope", "esign_webhook_events", ["provider", "envelope_id"])
