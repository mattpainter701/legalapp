...
_METADATA: dict[str, dict] = {
    "commercial-legal": {
        ...
        "matter_types": ["commercial", "contract", "vendor", "saas", "nda", "procurement"],
        "primary_route": "/plugins/commercial/renewals",
        "optional_integrations": ["google_drive", "onedrive", "sharepoint", "gmail", "outlook"],
    },
    "privacy-legal": {
        "category": "Compliance",
    ...
    "litigation-legal": {
        ...
        "matter_types": ["litigation", "dispute", "claim", "lawsuit", "demand", "subpoena"],
        "primary_route": "/plugins/litigation/matters",
        "optional_integrations": ["google_drive", "onedrive", "sharepoint", "gmail", "outlook", "calendar"],
    },
    "corporate-legal": {
        "category": "Transactions",
        "description": "M&A diligence, entity compliance, board minutes, written consents, and closing checklist workflows.",
        "matter_types": ["corporate", "m&a", "merger", "acquisition", "entity", "governance"],
    ...
    "family-law": {
        ...
        "optional_integrations": ["google_drive", "onedrive", "gmail", "outlook", "calendar"],
    },
    "criminal-defense": {
        "category": "Consumer Practice",
    ...
    "trust-estate-legal": {
        ...
        "matter_types": ["trust", "estate", "probate", "will", "beneficiary", "fiduciary"],
    ...
    "mediation-legal": {
        ...
        "skills": ["mediation-intake", "mediation-brief", "settlement-agreement", "caucus-summary"],
        "matter_types": ["mediation", "settlement", "dispute resolution", "family mediation"],
