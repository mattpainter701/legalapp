...
async def generate_recurring_invoices() -> dict:
    ...
    async with async_session_maker() as db:
        ...
        for tenant_id in tenant_ids:
            ...
            tenant_result = await _generate_recurring_invoices_for_tenant(
                db,
                tenant_id,
                today,
                generated,
            )
            generated += tenant_result["generated"]
            skipped += tenant_result["skipped"]
...
async def _generate_recurring_invoices_for_tenant(
    db, tenant_id: uuid.UUID, today: date, generated_so_far: int
) -> dict:
    generated = 0
    skipped = 0
    errors = 0
