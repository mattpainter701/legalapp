...
def _customer_task_title(caller_name: str, title: str | None) -> str:
    customer = (caller_name or "").strip() or "Unknown caller"
    base = (title or "").strip() or "Call back caller"
    if base.lower().startswith(customer.lower()):
        return base
