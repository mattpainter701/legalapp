...
LATEST_RELEASE_ID = "2026.09.08.12"
...
def test_release_catalog_returns_latest_release_and_history():
    ...
    assert latest["highlights"][0]["title"] == "Approve the exact recurring plan"
    assert latest["highlights"][-1]["title"] == "Keep recurring work reviewable"
