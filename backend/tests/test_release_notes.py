...
LATEST_RELEASE_ID = "2026.09.11.13"
LATEST_RELEASE_DATE = date(2026, 9, 11)
...
def test_release_catalog_returns_latest_release_and_history():
    ...
    assert latest["highlights"][0]["title"] == "Review questionnaire updates instead of retyping them"
