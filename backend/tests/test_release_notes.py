...
LATEST_RELEASE_ID = "2026.09.08.5"
...
def test_release_catalog_returns_latest_release_and_history():
    ...
    assert latest["highlights"][0]["title"] == "Maintain firm details once"
    assert latest["highlights"][-1]["title"] == "See shared values and missing setup"
