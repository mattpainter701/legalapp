...
LATEST_RELEASE_ID = "2026.09.07.17"
...
def test_release_catalog_returns_latest_release_and_history():
    ...
    assert latest["highlights"][0]["title"] == "Choose template AI separately"
    assert latest["highlights"][-1]["title"] == "Track premium template usage"
