...
LATEST_RELEASE_ID = "2026.09.07.19"
LATEST_RELEASE_DATE = date(2026, 9, 7)
...
def test_release_catalog_returns_latest_release_and_history():
    ...
    assert latest["highlights"][0]["title"] == "Continue working with your documents"
    assert latest["highlights"][-1]["title"] == "Keep planning on an approved route"
