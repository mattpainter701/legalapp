...
LATEST_RELEASE_ID = "2026.09.08.2"
LATEST_RELEASE_DATE = date(2026, 9, 8)
...
def test_release_catalog_returns_latest_release_and_history():
    ...
    assert latest["highlights"][0]["title"] == "Predictable connection limits"
    assert latest["highlights"][-1]["title"] == "Separate assistant and platform usage"
