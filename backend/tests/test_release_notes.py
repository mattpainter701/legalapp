...
LATEST_RELEASE_ID = "2026.09.07.20"
...
def test_release_catalog_returns_latest_release_and_history():
    ...
    assert latest["highlights"][0]["title"] == "Save supported background profiles"
    assert latest["highlights"][-1]["title"] == "Meter free responses accurately"
