...
LATEST_RELEASE_ID = "2026.09.07.12"
...
def test_release_catalog_returns_latest_release_and_history():
    ...
    assert latest["highlights"][0]["title"] == "Retry the matters that need it"
    assert latest["highlights"][-1]["title"] == "See partial results clearly"
