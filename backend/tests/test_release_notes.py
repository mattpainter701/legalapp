...
LATEST_RELEASE_ID = "2026.09.07.21"
...
def test_release_catalog_returns_latest_release_and_history():
    ...
    assert latest["highlights"][0]["title"] == "See the right appointment time"
    assert latest["highlights"][-1]["title"] == "Keep all-day events on their date"
